...
public class TemperedGlassTrapdoorBlock extends TrapDoorBlock {
	public TemperedGlassTrapdoorBlock() {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(TemperedGlassModBlocks.TEMPERED_GLASS_TRAPDOOR, RenderType.translucent());
	}
}
