...
public class TemperedGlassSlabBlock extends SlabBlock {
	public TemperedGlassSlabBlock() {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(TemperedGlassModBlocks.TEMPERED_GLASS_SLAB, RenderType.translucent());
	}
}
